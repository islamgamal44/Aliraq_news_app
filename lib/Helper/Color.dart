...
extension colors on ColorScheme {
  ...
  static const Color primary = Color(0xff033262);
  static const Color introSubtitleColor = Color(0xffff3f4c);
  static const Color tempboxColor = Color(0xffffffff);
  static const Color splashBackgroundColor = Color(0x59102041);
