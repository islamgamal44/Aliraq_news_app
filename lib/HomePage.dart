...
//fbAud
  ...
  Widget showCoverage() {
    return normalNewsList.isNotEmpty
        ? Column(
            children: [
              Stack(
                children: [
              ...
              Container(
                  ...
                  decoration: BoxDecoration(
                    ...
                    color:
                        Theme.of(context).colorScheme.coverage.withOpacity(0.9),
                    boxShadow: [
                      BoxShadow(
                    ...
                    child: Column(
                      ...
                      children: <Widget>[
                        Text(
                          ...
                          style: Theme.of(this.context).textTheme.subtitle2?.copyWith(color:Theme.of(context).colorScheme.fontColor, fontWeight: FontWeight.w600),
                          overflow: TextOverflow.ellipsis,
                          softWrap: true,
                          maxLines: 1,
                        ),
                        ...
                        Expanded(
                          child: Padding(
                              ...
                              child: Row(
                                ...
                                children: <Widget>[
                                  /*Icon(Icons.arrow_upward_outlined,size: 13.0,
                                      color: Theme.of(context).colorScheme.fontColor),*/
                                  Text("H:${weatherData!.maxTempC!.toString()}\u2103",
                                    style: Theme.of(this.context).textTheme.caption?.copyWith(color: Theme.of(context).colorScheme.fontColor.withOpacity(0.8)),
                                    maxLines: 1,
                                    overflow: TextOverflow.ellipsis,
                                    softWrap: true,
                                  ),
                                  Padding(padding: EdgeInsetsDirectional.only(start: 8.0),
                                    /*child: Icon(Icons.arrow_downward_outlined, size: 13.0,
                                          color: Theme.of(context).colorScheme.fontColor)),*/),
                              ...
                              Navigator.of(context).push(MaterialPageRoute(
                                  builder: (BuildContext context) =>
                                      ShowMoreNewsList(
                                        ...
                                        isDetails: false,
                                        news1: tempBreak,
                                        newsType: getTranslated(
                                            context, 'breakingNews_lbl')!,
                                      )));
                            },
                  ...
                  Container(
                      ...
                      child: AspectRatio(
                          ...
                          child: CachedNetworkImage(
                            ...
                            fit: BoxFit.fill,
                            errorWidget: (context, error, stackTrace) =>
                                errorWidget(deviceHeight! / 2.6, 6.5),
                            placeholder: (context, url) {
                              return placeHolder();
                            },
                          ))),
                ...
                children: [
                  Row(
                    children: [
                      Padding(
                          padding:
                              EdgeInsetsDirectional.zero, // .only(start: 8.0),
                          child: Text(
...
//get latest news data list
  ...
  Future<void> getLiveNews() async {
    ...
    _isNetworkAvail = await isNetworkAvailable();
    if (_isNetworkAvail) {
      var parameter = {ACCESS_KEY: access_key, LANGUAGE_ID: CUR_LANGUAGE_ID};
  ...
  Future<void> getCat() async {
    ...
    if (_isNetworkAvail) {
      ...
      if (error == "false") {
        ...
        var tempCategories =
            (data as List).map((data) => new Category.fromJson(data)).toList();
      ...
      try {
        ...
        if (response.statusCode == 200) {
          ...
          if (error == "false") {
            ...
            var tempBreakList = (data as List)
  ...
  Future getNewsVideoURL() async {
    ...
    if (_isNetworkAvail) {
      try {
        ...
        print(parameter);
        http.Response response = await http
            .post(Uri.parse(getVideosApi), headers: headers, body: parameter)
            .timeout(Duration(seconds: timeOut));
        ...
        if (error == "false") {
          ...
          if (mounted) {
            ...
            //  videoItems.clear();
            var mainlist = (newsData as List)
                .map((data) => new News.fromVideos(data))
                .toList();

            videoItems.addAll(mainlist);
