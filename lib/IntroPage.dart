...
class _GettingStartedScreenState extends State<IntroSliderScreen>
  ...
  Widget build(BuildContext context) {
    ...
    deviceHeight = MediaQuery.of(context).size.height; //despite or dark / light theme
    return Scaffold(
    ...
    return PreferredSize(
      ...
      child: Padding(
        padding: EdgeInsetsDirectional.only(
            top: MediaQuery.of(context).padding.top + 10.0, start: 20, end: 16),
        child: Row(
            ...
            children: [
              ...
              /*TextButton(
                style: ButtonStyle(
                  ...
                  foregroundColor: MaterialStateProperty.all(colors.darkColor1.withOpacity(0.4)),
                ),
                onPressed: () async {
                  ...
                  if (!isFirstTime) {
                    ...
                    Navigator.pushReplacement(
                      context,
                      MaterialPageRoute(builder: (context) => LanguageList(from: 1)),
                    );
                  }
                },
                child: Text(
    ...
    return Container(
      ...
      child: Text(
        ...
        style: Theme.of(context).textTheme.headlineSmall?.copyWith(
            color: colors.introSubtitleColor,
  ...
  NxtButton(int index) {
    return ElevatedButton(
      ...
      child: Text(
        ///getTranslated(context, (index == (slideList.length - 1)) ? 'login_btn' : 'nxt')!,
        getTranslated(context, 'open_btn')!,
