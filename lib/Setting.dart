...
import 'package:news/Model/PageModel.dart';
  ...
  Future getOtherPages() async {
    ...
    if (_isNetworkAvail) {
      try {
        ...
        print(parameter);
        Response response = await post(Uri.parse(getPagesApi),
        ...
        if (error == "false") {
          if (mounted) {
            ...
            var mainlist = (newsData as List)
                .map((data) => new PageModel.fromJson(data))
                .toList();

            setState(() {
              pages.addAll(mainlist);
            });
          }
        } else {
          print("No Pages");
    ...
    return CUR_USERID != ""
        ? Stack(children: <Widget>[
            ...
            Positioned.directional(
              ...
              height: CUR_USEREMAIL != ""? 130 : CUR_USERNAME != "" ? 130 : 100,
              child: ClipRRect(
                  //User Image
                  borderRadius: BorderRadius.circular(20.0),
                  child: ShaderMask(
                    shaderCallback: (bounds) {
                      return LinearGradient(
                          ...
                          colors: [ Colors.transparent, colors.secondaryColor.withOpacity(0.6)]).createShader(bounds);
                    },
              ...
              child: Column(
                ...
                children: <Widget>[
                  Text(getTranslated(context, 'name_lbl')!,
                      style: Theme.of(context).textTheme.subtitle2?.copyWith( color: colors.tempboxColor,)),
                  if (name != null)
                    Text(name!,
                        style: Theme.of(context).textTheme.subtitle1?.copyWith(color: colors.tempboxColor)),
                ],
              )),
          Spacer(),
          Padding(
            ...
            child: ListView(
              ...
              children: <Widget>[
                ...
                if (CUR_USERID != "" && role != "0")
                  setDrawerItem(getTranslated(context, 'CREATE_NEWS_LBL')!,
                      Icons.add_box_outlined, false, true, false, 4
                      /* ManagePref(
                            from:
                                1), */ /*  boolFunc: () {
                        return null;
                ...
                if (CUR_USERID != "" && role != "0")
                  setDrawerItem(getTranslated(context, 'MANAGE_NEWS_LBL')!,
                      Icons.edit_note, false, true, false, 5
                      /* ManagePref(
                            from:
                                1), */ /*  boolFunc: () {
                        return null;
      ...
      return ScrollConfiguration(
        ...
        child: ListView.builder(
          ...
          itemBuilder: ((context, index) => setDrawerItem(
              pages[index].title!, Icons.info_rounded, false, true, false, 7,
              image: pages[index].image!, desc: pages[index].pageContent)),
        ),
      );
    } else {
    ...
    return ListTile(
      ...
      leading: image != null
          ? CachedNetworkImage(
              ...
              errorWidget: (context, error, stackTrace) => errorWidget(20, 20),
